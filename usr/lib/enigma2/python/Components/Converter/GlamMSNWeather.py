...
# Виктор Абалакин - Astroномический календарь
#
...
# Astral time
		...
		STT = math.fmod((6.697374558333 + 2400.0513369072223 * T + 0.0000258622 * T * T - 0.00000000172 * T * T * T), 24) # astral time at Greenwich midnight 
		ST = math.fmod((STT + UT * 1.0027379093 - zone * 1.0027379093 + long / 15), 24) # local star time
		if ST < 0:
			ST = ST + 24
		ST = ST * 15 # Star time at the time of calculation in degrees
