# -*- coding: UTF-8 -*-
## Based on MSNWeather Converter
## Coded by Sirius
## version 0.7
## modded by MCelliot_g for Glamour Skins
## fixed skin crash when WeatherMSN plugin is not installed
## if you like to use this converter in your own skins, please keep the lines above
...
if pathExists("/usr/lib/enigma2/python/Plugins/Extensions/WeatherMSN"):
	try:
